...
export function SignInForm() {
  ...
  return (
    <div className="fixed w-full left-0 top-0  flex items-center justify-center h-full bg-yellow-100">
      <div className=" max-w-lg w-full h-full bg-yellow-100 rounded-2xl p-4 md:p-8 flex flex-col gap-6">
        <h2 className="text-center text-3xl font-bold text-yellow-900 font-serif mb-2 mt-12">PathBound</h2>
        ...
        <div className="flex items-center justify-center my-3">
          <hr className="my-4 grow border-yellow-300" />
